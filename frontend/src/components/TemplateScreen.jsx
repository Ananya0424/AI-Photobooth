  ...
  return (
    <>
      <style>{`
        ...
        @keyframes ts-card-in   { 0%{opacity:0;transform:translateY(28px)} 100%{opacity:1;transform:translateY(0)} }
        ...
        @keyframes ts-img-zoom  { 0%{transform:scale(1)} 100%{transform:scale(1.06)} }
        ...
        .ts-card.selected { transform: translateY(-8px) scale(1.012); }
      ...
      <div style={{
        ...
        <div style={{
          ...
          {isLoading ? (
            ...
            <>
              {/* Header */}
              <div style={{ textAlign: 'center', marginBottom: '32px', animation: 'ts-scale-in 0.5s ease-out', width: '100%', maxWidth: '680px' }}>
                <h2 style={{
              ...
              {/* Template grid — 1 column, large cards for portrait kiosk */}
              <div style={{
                display: 'grid',
                gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))',
                gap: '24px', width: '100%', maxWidth: '700px',
              }}>
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        border: isSelected ? `2px solid ${acc.glow}80` : '1px solid rgba(255,255,255,0.08)',
                        boxShadow: isSelected
                          ? `0 0 0 1px ${acc.glow}30, 0 28px 56px ${acc.glow}22`
                          : isHovered ? '0 20px 40px rgba(0,0,0,0.45)' : '0 6px 20px rgba(0,0,0,0.35)',
                      }}
                    >
                      {/* Image area — tall portrait ratio */}
                      <div style={{
                        position: 'relative', overflow: 'hidden',
                        aspectRatio: '3 / 4',
                        ...
                        {tpl.previewImage ? (
                          ...
                          <div style={{ textAlign: 'center' }}>
                            ...
                            <p style={{ color: `${acc.glow}`, fontSize: '13px', fontWeight: '600', letterSpacing: '1px', textTransform: 'uppercase', opacity: 0.8 }}>
                              {tpl.backgroundName}
                            </p>
                          </div>
                        )}
                        ...
                        <div style={{
                          ...
                          border: `1px solid ${acc.glow}40`,
                          color: '#fff', padding: '7px 22px', borderRadius: '20px',
                          fontSize: '12px', fontWeight: '800', letterSpacing: '1.5px',
                          textTransform: 'uppercase', whiteSpace: 'nowrap',
                          boxShadow: `0 4px 12px rgba(0,0,0,0.5), 0 0 16px ${acc.glow}20`,
                        }}>{tpl.name}</div>
                        ...
                        <div style={{
                          ...
                          background: acc.badge, border: `1px solid ${acc.glow}50`,
                          display: 'flex', alignItems: 'center', justifyContent: 'center',
                          color: acc.badgeText, fontSize: '13px', fontWeight: '800',
                        }}>{idx + 1}</div>
                      </div>
                      ...
                      <div style={{
                        ...
                        borderTop: `1px solid ${acc.glow}20`,
                      }}>
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                          <div>
                            <p style={{ color: '#f1f5f9', fontSize: '17px', fontWeight: '700', marginBottom: '3px' }}>{tpl.name}</p>
                            <p style={{ color: '#64748b', fontSize: '12px' }}>{tpl.backgroundName}</p>
                          </div>
                          <div style={{
                            padding: '8px 16px', borderRadius: '10px',
                            background: isSelected ? 'linear-gradient(135deg, #a855f7, #ec4899)' : acc.badge,
                            border: `1px solid ${isSelected ? 'transparent' : `${acc.glow}40`}`,
